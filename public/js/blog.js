$(document).ready(function(){
	...
	{
		$('.search_result').append('<ul class="list-group list-group-lg no-bg auto m-b-none m-t-n-xxs" id="list_listen"><li class="list-group-item clearfix"><a href="#" class="pull-right active m-t-sm m-l text-md" data-toggle="class"><i class="fa fa-heart-o text-active" onclick="like('+id+')"></i><i class="fa fa-heart text text-danger" onclick="cancel_like('+id+')"></i></a><a href="#" class="pull-right active m-t-sm m-l text-md" data-toggle="class"><i class="fa fa-plus-circle text-active" onclick="add(this)" data-toggle="modal" data-target="#myModal"><i style="display:none">'+id+'</i><\/i><i class="fa fa-check-circle text text-info"><\/i><\/a><a href="#" class="jp-play-me pull-right m-t-sm m-l text-md"><i style="display: none;" id="num">0</i><i class="icon-control-play text" onclick="poster(this)"><i style="display:none;">'+data[0].poster+'</i></i><i class="icon-control-pause text-active"></i></a><a href="#" class="pull-left thumb-sm m-r"><img src="'+data[0].poster+'" alt="..."></a><a class="clear" href="#"><span class="block text-ellipsis">'+data[0].title+'</span><small class="text-muted">'+data[0].artist+'</small></a></li></ul>');
	}
